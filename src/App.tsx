...
let editorBooted = wasmBooted.then(() => {
  return new Promise<SemanticEditor>((resolve, reject) => SemanticEditor.new('wss://echo.websocket.org', resolve, reject)).then(e => {
    editor = e;
  }).catch(e => {
    console.error('Could not create SemanticEditor', e);
  });
});
